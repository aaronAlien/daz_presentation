  ...
  return (
    <div className='max-w-2xl mx-auto'>
      ...
      <div className='absolute lg:-bottom-8 z-10 lg:left-16 max-w-[60%]'>
        <h1 className='text-10rem font-courier-prime font-bold lg:leading-44 tracking-widest'>
          PECKHAM <br />
          DAZ
        </h1>
      </div>
      <div className='absolute -bottom-16 z-0 right-0 lg:right-16 max-w-[60%] p-0'>
